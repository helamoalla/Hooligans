...
//ToString 
    ...
    public String toString() {
        return "LignePanier{" + "id_ligne=" + id_ligne + ", panier=" + panier + ", produit=" + produit + ", prix_u=" + prix_u + ", quantite=" + quantite + ", nom_produit=" + nom_produit + ", description=" + description + ", image=" + image + '}';
    }
