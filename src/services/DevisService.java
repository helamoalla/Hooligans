...
public class DevisService {
    ...
    public List<Devis> fetchDevis(Maintenance id ) {
        
        req = new ConnectionRequest();
      

        //1
        String fetchURL = Statics.BASE_URL + "/devissjson";
    //    req.addArgument("id", String.valueOf(id.getId_maintenance()));
        //2
        req.setUrl(fetchURL);
    ...
    public List<Devis> parseDevis(String jsonText) {
        ...
        public boolean sendmail(double id ) {
        String url = Statics.BASE_URL +"/emailjson/"+(int)id;
