...
private PanierService ps = new PanierService();
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       tfmontanttotal.setText(String.valueOf(ps.totalmontantPanier(3))+"DT");
    }    
    ...
    /****************Afficher panier by id_user***********************/
        ...
        listprod.addAll(lps.AfficherPanierbyiduser(3));
        ...
        int row = 1;
            ...
            try {
                ...
                fxmlLoader.setLocation(getClass().getResource("/view/LignePanier.fxml"));
