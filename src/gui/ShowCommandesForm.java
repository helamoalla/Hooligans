...
//    for (MaisonHote maison : maisons) {
//        // Create a paragraph for the question
//        Paragraph nameParagraph = new Paragraph(maison.getTitre());
...
//        list.add(new ListItem(maison.getTitre(), listItemFont));
//        list.add(new ListItem(maison.getDescription(), listItemFont));
//        list.add(new ListItem(maison.getAdresse(), listItemFont));
//        // Add the list to the document
//        document.add(list);
//
//        // Create a paragraph for the response
//        Paragraph responseParagraph = new Paragraph("La maison est " + maison.getStatus_hebergement());
...
//}
//
//    w hedhy button   Button pdfBtn = new Button("Download PDF");
