 ...
 * @author choua
 */
public class ShowGarageForm extends BaseForm {
    
   public ShowGarageForm(Resources res) {    
      super("Newsfeed", BoxLayout.y());
        ...
        addTab(swipe, res.getImage("back.jpg"), spacer1, "", "", "Votre Garage");
        ...
        GarageCService ps = GarageCService.getInstance();
     List<GarageC> list = ps.fetchGarageC();
...
//          }
    ...
    Label nomProduitLabel = new Label("Nom du garage: " + l.getNom_garage());
    nomProduitLabel.setBadgeUIID("1");
    Label prixLabel = new Label("adresse: " + l.getAdresse());
     prixLabel.setBadgeUIID("2");
    Label quantiteLabel = new Label("numero: " +  (int)l.getNumero());
     quantiteLabel.setBadgeUIID("3");
    Label SousMoantantLabel = new Label("taux de reduction: " +  l.getTaux_de_reduction()+" DT");
      SousMoantantLabel.setBadgeUIID("4");
    ...
    Button deleteButton = new Button("Plus de détail");
    ...
    deleteButton.addActionListener(e -> { 
          new ShowDetailGarageForm(res,l).show();
