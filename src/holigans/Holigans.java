...
public class Holigans {
    ...
    public static void main(String[] args) {
       // try {
            ...
            //stp.verifyCardAndPay("4242424242424242",02, 2030, "123", "200","Aziz Hajjem");
        //} catch (StripeException ex) {
          //  Logger.getLogger(Holigans.class.getName()).log(Level.SEVERE, null, ex);
       // }
//       BonPlan b = new BonPlan();
//       b.setId_bonplan(89);
//        System.out.println(feedbackService.checkIfAlreadyReported(b));
